...
def test_10cv():
    ...
    po_label = 9
    loops = 5
    file_name = "mnist" + str(po_label) + ".none"
    ...
    print("=================================================")
    print("miFV with %s" % file_name.split("/")[-1].split(".")[0])

    # "D:/Data/OneDrive/文档/Code/MIL1/Data/Text/talk_religion_misc.mat"
    mnist_path = "D:/Data/OneDrive/文档/Code/MIL1/Data"
    bags = MnistLoader(seed=1, po_label=po_label, mnist_path=mnist_path).bag_space
    mil = miFV(file_name, bags=bags)
